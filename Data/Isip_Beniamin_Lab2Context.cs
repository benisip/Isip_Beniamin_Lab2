...
namespace Isip_Beniamin_Lab2.Data
{
    public class Isip_Beniamin_Lab2Context : DbContext
    {
        ...
        public DbSet<Isip_Beniamin_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Isip_Beniamin_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Isip_Beniamin_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
