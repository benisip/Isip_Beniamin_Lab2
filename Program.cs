...
options.UseSqlServer(builder.Configuration.GetConnectionString("Isip_Beniamin_Lab2Context") ?? 
throw new InvalidOperationException("Connection string 'Isip_Beniamin_Lab2Context' not found.")));
